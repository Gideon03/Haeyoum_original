...
public class PhotoController {
	...
	public String photolist(Photo photo, PhotoFile photoFile, Model model, @ModelAttribute("user") LoginUser user) {
	...
	public String addphoto(Model model, Photo photo, Location location, @RequestParam ArrayList<MultipartFile> files,
			@ModelAttribute("realPath") String realPath, @ModelAttribute("user") LoginUser user) {

		photo.setPhoto_writer(user.getMember_id());
		photo.setGroup_id(user.getGroup_id());
	...
	public String videomodify(PhotoView photoView,Model model, @ModelAttribute("user") LoginUser user) {
