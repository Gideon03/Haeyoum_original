...
public class VideoController {
	...
	public String VideoList(Model model, @ModelAttribute("user") LoginUser user) {
	...
	public String addVideo(Model model, Video video, Location location,
		...
		video.setVideo_writer(user.getMember_id());
	...
	public String videomodify(VideoView videoView, Model model, @ModelAttribute("user") LoginUser user) {
