...
public class GroupController {
	...
	public String groupReg(@ModelAttribute("user") LoginUser user) {
		return GROUP_FORM;
	}
	...
	public String groupReg(@ModelAttribute("user") LoginUser user, Group group, Model model) {
		...
		group.setGroup_admin_id(user.getMember_id());
	...
	public String groupList(@ModelAttribute("user") LoginUser user, Model model) {
		user.setGroup_id(0);
		int stPage = 0;
	...
	public String inviteCode(@ModelAttribute("user") LoginUser user, @RequestParam("inviteCode") String reqCode,
			Model model) {
		...
		Group inGroup = groupSvc.inviteGroup(reqCode, user.getMember_id());
		if(inGroup == null) {
		...
		groupMemberSvc.insertGroupMember(inGroup.getGroup_id(), user.getMember_id());

		return REDIRECT_GROUP_LIST;
	}
	
	@RequestMapping("/room")
	public String room(@ModelAttribute("user") LoginUser user, 
