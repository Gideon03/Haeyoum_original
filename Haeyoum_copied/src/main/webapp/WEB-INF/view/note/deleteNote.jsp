	...
	<div id="content" class="site-content center-relative">
		<div class="single-post-wrapper content-1070 center-relative">
			...
			<article class="center-relative">
				<h1 class="entry-title">노트삭제</h1>
					<div class="entry-content">
						<div class="content-wrap content-660 center-relative">
							<div class="entry-content p-b-32">
								<h4>정말로 노트를 <strong >삭제</strong>하시겠습니까?</h4>
								<span class="txt1">삭제된 글은 복구가 불가능합니다.</span>
							</div>
							<form class="logout100-form validate-form flex-sb flex-w" action="${pageContext.request.contextPath}/group/note/deleteNote" method="post">
