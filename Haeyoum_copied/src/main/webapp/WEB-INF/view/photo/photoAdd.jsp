...
<body class="single-post" >
        ...
        <!-- 아티클 안에 내용작성하시면 됩니다 아래의 내용은 영역비율을 보기위한 샘플입니다. -->
			...
			<div class="blog-holder center-relative">
				<a href="${pageContext.request.contextPath}/group/photo/photoList">사진 목록보기</a>
				
					<h2>사진 등록해윰</h2>
				
						<form action="${pageContext.request.contextPath}/group/photo/photoAdd"
							method="post" enctype="multipart/form-data">
							<input type="hidden" value="102" name="sort_id">
							...
							<div>
								제목 <input name="photo_name" size="80" placeholder="제목을 입력해주세요" required="required" />
							</div>
							
							<div>
								사진 파일 등록 <input name="files" type="file" required="required" multiple />
							</div>
							
							<div>
								내용 <input name="photo_text" size="20" placeholder="내용을 입력해주세요" />
							</div>
