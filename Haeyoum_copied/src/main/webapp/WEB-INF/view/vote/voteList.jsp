		  	...
		  	<article class="center-relative">
				<div class="wrap-login100-vote p-t-55 p-b-55">
					...
					<div class="container-note-btn">
						<button class="note-btn" onclick="location.href='${pageContext.request.contextPath}/group/vote/create'">
						만들기
						</button>
					</div>
					<table class="table table-hover table-responsive">
						...
						<tr>
							...
							<th class="txt1 p-b-11 text-center th-date" >시작일</th>
							<th class="txt1 p-b-11 text-center th-date" >종료일</th>
						</tr>

						<c:forEach items="${voteList}" var="vote" >
						<tr>
							<td class="txt1 p-b-11 th-title" >
								<a href="${pageContext.request.contextPath}/group/vote/voteContent?con_id=${vote.con_id}">
									${vote.vote_name}
								</a>
							</td>
							<td class="txt1 p-b-11 text-center th-writer" >${vote.vote_writer}</td>
							<td class="txt1 p-b-11 text-center th-date" >${vote.vote_startdate}</td>
							<td class="txt1 p-b-11 text-center th-date" >${vote.vote_enddate}</td>
						</tr>
						</c:forEach>
					</table>
				</div>
