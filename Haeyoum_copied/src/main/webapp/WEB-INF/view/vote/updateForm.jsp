		...
		<div class="single-post-wrapper content-1070 center-relative">
		  	<article class="center-relative">
				<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
					<form class="form-signin" action="${pageContext.request.contextPath}/group/vote/update" method="post">
						...
						<div class="wrap-input100 validate-input m-b-36" data-validate = "Vote name is required">
							<input class="input100" type="text" name="vote_name" autofocus required value="${vote.vote.vote_name}">
